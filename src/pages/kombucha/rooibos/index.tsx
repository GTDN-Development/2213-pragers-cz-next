    ...
    <Layout>
      ...
      <section className="bg-rooibos-800">
        <Container py="xl" className="relative">
          ...
          <Reveal noVertical>
            <div className="absolute top-10 right-0 z-10 h-52 w-52 origin-top text-rooibos-700 md:top-2/3 md:h-2/3 md:w-1/2 md:-translate-y-2/3">
              <img
      ...
      <section className="bg-rooibos-800">
        <Container py="md" className="grid gap-12 sm:grid-cols-12">
          ...
          >
            <Image
              src="/images/kombucha/rooibos/render-can-outline.png"
